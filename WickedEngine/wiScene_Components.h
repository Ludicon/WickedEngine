...
namespace wi::scene
{
	...
	struct MaterialComponent
	{
		...
		inline bool IsPreferBC7TexturesEnabled() const { return _flags & PREFER_BC7_TEXTURES; }
		...
		inline void SetPreferBC7TexturesEnabled(bool value = true) { if (value) { _flags |= PREFER_BC7_TEXTURES; } else { _flags &= ~PREFER_BC7_TEXTURES; } CreateRenderData(true); }
